...
public class Order_onProccess extends Fragment {

    private Retrofit retrofit;
    APIService service;
    String ID_USER;
    MyOrderAdapter adapter;
     public Order_onProccess() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_order_on_proccess, container, false);
        retrofit = Utils.getRetrofit();
        service = retrofit.create(APIService.class);
        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.rv_order_on_proccess);
    ...
    private void loadOrder() {
        ...
        Call<MyOrderResponse> call_order = service.getOrder(ID_USER, "2");
